...
class LeftPanelLogin extends React.Component{
    constructor(props){
        super(props);
    ...
    responseFacebook(res) {
        ...
        dispatch(userActions.loginWith3rd(id,email,data,'',(err,e)=>this.pageSwitch(err,e)));
    }
...
const connected=connect(mapStateToProps)(LeftPanelLogin);
export { connected as LeftPanelLogin}