...
class ViewProfileDetail extends React.Component{
    constructor(props){
        super(props);
        this.state={
    ...
    render(){
        const { users,userDetails,memberDetail } = this.props;
        ...
        _figure     =[
                {
                    label           : 'Dân tộc',
                    value           : 'Người châu Á',
                    iconClass       : icon.iconEthnicity,
                 },{
                    label           : 'Hình dáng',
                    value           : 'Mảnh khảnh',
                    iconClass       : icon.iconBodyType,
                 },{
                    label           : 'Chiều cao',
                    value           : '140 cm',
                    iconClass       : icon.iconHeight,
                 },{
                    label           : 'Màu tóc',
                    value           : 'Đen',
                    iconClass       : icon.iconHair,
                 },
                 {
                    label           : 'Tôi đeo',
                    value           : 'Không đeo kính/áp tròng',
                    iconClass       : icon.iconGlasses,
                 },{
                    label           : 'Phong cách ăn mặc',
                    value           : 'Khác',
                    iconClass       : icon.iconClothing,
                 },
                {
                    label           : 'Điểm đẹp nhất của tôi',
                    value           : 'Mắt',
                    iconClass       : icon.iconBestPart,
                 },{
                    label           : 'Diện mạo chung',
                    value           : 'Không xấu',
        ...
        _favourites =[
                {
                    label           : 'Món ăn',
                    value           : 'dan toc',
                    iconClass       : icon.iconFavDish,
                 },{
                    label           : 'Ẩm thực',
                    value           : 'dan toc',
                    iconClass       : icon.iconFavCuisin,
                 },{
                    label           : 'Uống',
                    value           : 'nuoc loc',
                    iconClass       : icon.iconFavDrink,
                 },{
                    label           : 'Thể loại âm nhạc',
                    value           : 'chu tinh',
                    iconClass       : icon.iconFavMusicGenre,
                 }
            ];
        _personality=[
                {
                    label           : 'Tính cách',
                    value           : 'Hòa đồng, Bình tĩnh, Vui vẻ, Nghiêm túc',
                    iconClass       : icon.iconCharacter,
                 },{
                    label           : 'Con cái',
                    value           : 'Có thể',
                    iconClass       : icon.iconKid,
                 },{
                    label           : 'Bạn bè',
                    value           : 'Vài người bạn',
                    iconClass       : icon.iconFriends,
                 }
            ];
            */
        const _data ={
        ...
        return(
            <div className="tw3-profile__body__box jsIndexDetails">
                ...
                <div>
                    ...
                    {data.fullname} đã điền <strong>{total_value} trong số {Object.keys(details).length}</strong> chi tiết.
                    </p>
                    <p className="mb--default">
                        <a href="javascript://" className="text--bold jsCompleteTheirProfileDetails">
                    YÊU CẦU CÔ ẤY HOÀN TẤT SƠ YẾU CỦA MÌNH</a>
                    </p>
                    <a href="/885579224?action=unlock" className="tw3-button tw3-button--subtle tw3-button--blue tw3-button--full tw3-button--rounded mb--default jsUnlockProfileDetails" style={{display: 'none'}}>
                    YÊU CẦU CÔ ẤY HOÀN TẤT SƠ YẾU CỦA MÌNH</a>
                </div>
...
function mapStateToProps(state){
    const {users, authentication, userDetails, memberDetail} = state; 
    return { users, authentication, userDetails,memberDetail };
}
const connectedViewProfileDetail = connect(mapStateToProps)(ViewProfileDetail);
export {connectedViewProfileDetail as ViewProfileDetail }