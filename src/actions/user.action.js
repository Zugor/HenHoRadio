...
export const userActions={
    ...
    getImageByUser,
    getImageByMember,
    getLikeMember, // Nguoi ban thich
    getLikeByUser, // Nguoi thich ban
    getUserById,
    getPhone,
    addLikeMember,
    addLikeByUser,
...
function getLikeByUser(id){
    return dispatch=>{
        dispatch(request());
        userService.getLikeByUser(id)
            .then(
...
function getLikeMember(id){
    ...
    function request(id) { return { type : userConstants.GET_LIKE_MEMBER_REQUEST,id }}
        ...
        userService.addLikeMember(user)
            .then(
                like=>{
                    ...
                    dispatch(alertActions.openBottom(obj))
