...
class LikeRightSide extends React.Component{
    render(){
        ...
        //console.log(view,"Like Right Side");
                    ...
                    <div className="tw3-completeContainer tw3-row">
                        <div className="jsBoostMenu jsUserComplete clearfix">
                            <div className="tw3-col-4">
                                <Link to="/profile" className=""><img src="https://twoo04-a.akamaihd.net/t/bb825237b35727d85c6d68e3345f8917_1_6_0_900_1200_180_180_0016630872.jpg" className="tw3-avatar tw3-avatar--circle tw3-avatar--fluid"/></Link>
                            </div>
                            <div className="tw3-col-8 ">
                                ...
                                <div className="clearfix jsContent">
                                    ...
                                    <p className="mb--tight">
                                        <Link to="/profile?editable=aboutme#panels" className="text--blue"><i className="ficonEdit"></i> Viết vài dòng về bạn</Link>
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <ul className="tw3-menu">
                <li>
                    <div className="tw3-row">
                        <Link to="/likes" className={(view=="likes") ?  "selected" : ''}>
                ...
                <li>
                    <div className="tw3-row">
                        <Link to="/activity/likes" className={(view=="activity_likes") ?  "selected" : ''}>
                            <div className="tw3-menu__avatar">
